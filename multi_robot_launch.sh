...
tmux send-keys "export MY_NO_ROBOTS=3" Enter
...
tmux send-keys "export MY_ROBOT=mp_400" Enter
tmux send-keys "export MY_NO_ROBOTS=3" Enter
tmux send-keys "ros2 launch neo_simulation2 multi_robot_navigation.launch.py" Enter

# Run rviz
tmux select-pane -t 2
tmux send-keys "ros2 run multi_navigator multi_commander " Enter
